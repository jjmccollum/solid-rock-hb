...
%		setups=mypenalties %discourage orphans and widows
	...
	\setuphead[section][
		...
		before={\blank[2*line]\testpage[3]}, %add two blank lines before, and if there is not room for three lines after the title, then force a page break
		after={\blank[line]},%add a blank line after
		indentnext=no%do not indent the paragraph that follows
	]
	...
	\setuphead[Info][
		placehead=no,%print the heading (necessary for the part heading, which isn't normally printed)
		number=no,%do not add a number to this heading
