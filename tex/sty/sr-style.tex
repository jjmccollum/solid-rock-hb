\startenvironment sr-style
	...
	\define\RdgClosedSection{%
		\{\ClosedSectionSymbol\}%add a bracketed representation of the break
	}
	...
	\define\RdgOpenSection{%
		\{\OpenSectionSymbol\}%add a bracketed representation of the break
	}
	...
	\setupheadertexts[\rlap{\switchtobodyfont[english, 11pt]\textdir TLT\RefRange}\hfill {\switchtobodyfont[hebrewheader, 13pt]\setcharacterkerning[headerkerning]\textdir TRT\getvariable{text}{book}} \hfill][][][\hfill {\switchtobodyfont[hebrewheader, 13pt]\setcharacterkerning[headerkerning]\textdir TRT\getvariable{text}{book}} \hfill \llap{\switchtobodyfont[english, 11pt]\textdir TLT\RefRange}] %even left, even right, odd left, odd right
