...
\definefontfeature[ebgaramond-normal][default][
	...
	protrusion=pure %allow punctuation to extend outside of the text block
]
...
\setupinterlinespace[60bp] %text line spacing
...
\startsetups[footnotesetup]
	...
	\setupbodyfont[keteryg, 10pt] %footnote font
	\setupalign[flushleft,nothyphenated] %alignment of text in columns
\stopsetups
...
\define[1]\StartSubMark{{\switchtobodyfont[apparatus, 11pt]⸃}\doifnot{#1}{1}{{\switchtobodyfont[ebgaramond, 11pt]\textsuperscript{#1}}}} %reverse symbol for RTL
\define\StopSubMark{{\switchtobodyfont[apparatus, 11pt]⸂}} %reverse symbol for RTL
\define[1]\AddMark{{\switchtobodyfont[apparatus, 11pt]⸆}\doifnot{#1}{1}{{\switchtobodyfont[ebgaramond, 11pt]\textsuperscript{#1}}}}
\define[1]\StartOmitMark{{\switchtobodyfont[apparatus, 11pt]⸋}\doifnot{#1}{1}{{\switchtobodyfont[ebgaramond, 11pt]\textsuperscript{#1}}}}
\define\StopOmitMark{{\switchtobodyfont[apparatus, 11pt]⸌}} %should reverse symbol for RTL, but Apparatus SIL doesn't include U2E0D
\define[1]\StartTransMark{\enquad{\switchtobodyfont[apparatus, 11pt]⸊}\doifnot{#1}{1}{{\switchtobodyfont[ebgaramond, 11pt]\textsuperscript{#1}}}} %reverse symbol for RTL
\define\StopTransMark{\nospace\nobreak\,{\switchtobodyfont[apparatus, 11pt]⸉}} %reverse symbol for RTL
